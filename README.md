...
Rubrik penilaian kualitas, prompt AI, dan lembar cetak dipindahkan tanpa perubahan logika,
sehingga skor dari kedua versi dapat dibandingkan langsung.
...
| `ANTHROPIC_API_KEY` | tidak | tanpa ini seluruh aplikasi tetap berfungsi, kecuali menu Analisis AI |
...
src/
  ...
  lib/
    ...
    ai-prompts.ts             system prompt dan struktur keluaran analisis
