...
import { InsightCard } from '@/components/InsightList';
import { insightsForSet } from '@/lib/rules';
  ...
  return (
    <>
      ...
      <main className="content">
        ...
        <InsightCard items={insightsForSet(notes).slice(0, 4)}
          judul="Insight dari catatan lapangan"
          hint={`sinyal terpilih dari ${notes.length} catatan, dihitung tanpa AI`}
          footer="Dipilih dari sinyal yang paling layak ditindaklanjuti. Rincian lengkapnya ada di menu Analisis." />
