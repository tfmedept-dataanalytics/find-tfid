...
import { insightsForNote } from '@/lib/rules';
    ...
    <div className="ovl" id="modalWrap" onClick={e => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="modal">
        ...
        <div className="modal-b">
          ...
          <div className="sec-h" style={{ marginTop: '1.4rem' }}><span className="ltr">◈</span><h2>Insight catatan ini</h2>
            <span className="n">dihitung tanpa AI</span></div>
          <InsightList items={insightsForNote(note)}
            kosong="Tidak ada sinyal menonjol yang terdeteksi dari isi catatan ini." />
