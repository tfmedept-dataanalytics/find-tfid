...
import { ruleAnalyze, insightsForSet, clip, type Faktor } from '@/lib/rules';
import { InsightCard } from './InsightList';
...
export function RuleReport({ notes }: { notes: Note[] }) {
  ...
  return (
    <>
      <InsightCard items={insightsForSet(notes)}
        judul="Insight utama"
        hint={`sinyal terpilih dari ${n} catatan, diurutkan menurut tingkat perhatian`}
        footer="Butir di atas adalah pilihan dari hitungan lengkap yang dirinci di bawah. Tingkat perhatian ditentukan aturan tetap, bukan penilaian AI." />
